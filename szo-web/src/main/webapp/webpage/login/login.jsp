...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   ...
   <div class="inner">
    <div class="logo">
     <img src="plug-in/login/images/toplogo-szo.png"/>
    </div>
    <div class="formLogin">
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="#" title="SZO 新版演示系统">szo</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="SZO 新版演示系统">szo</a></span>
   </div>
  </div>
    <!-- Link JScript-->
