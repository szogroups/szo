...
<script type="text/javascript">
	...
	$('#addCustomBtn').bind('click', function(){   
 		 var tr =  $("#add_szoStudent_table_template tr").clone();
	 	 $("#add_szoStudent_table").append(tr);
	 	 resetTrNum('add_szoStudent_table');
    });  
	$('#delCustomBtn').bind('click', function(){   
      	$("#add_szoStudent_table").find("input:checked").parent().parent().remove();   
        resetTrNum('add_szoStudent_table'); 
    }); 
