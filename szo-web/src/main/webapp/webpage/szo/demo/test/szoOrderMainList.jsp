...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="szoOrderMainList" title="订单信息" actionUrl="szoOrderMainController.do?datagrid" idField="id" fit="true">
   ...
   <t:dgDelOpt title="删除" url="szoOrderMainController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="szoOrderMainController.do?addorupdate" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="szoOrderMainController.do?addorupdate" funname="update"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>
