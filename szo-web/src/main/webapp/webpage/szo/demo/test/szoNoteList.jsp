...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="szoNoteList" title="单表模型" actionUrl="szoNoteController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgDelOpt title="删除" url="szoNoteController.do?del&id={id}" />
   <t:dgToolBar title="录入" icon="icon-add" url="szoNoteController.do?addorupdate" funname="add" operationCode="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="szoNoteController.do?addorupdate" funname="update"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>