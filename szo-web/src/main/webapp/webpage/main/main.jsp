...
<SCRIPT type="text/javascript">
	$(function() {
		$('#layout_szo_onlineDatagrid').datagrid({
			...
			onLoadSuccess : function(data) {
				$('#layout_szo_onlinePanel').panel('setTitle', '( ' + data.total + ' )人在线');
			}
		...
		$('#layout_szo_onlinePanel').panel({
			tools : [ {
				iconCls : 'icon-reload',
				handler : function() {
					$('#layout_szo_onlineDatagrid').datagrid('load', {});
				}
			} ]
		});
		...
		$(".layout-expand").click(function(){
			...
			$("#layout_szo_onlinePanel").find(".datagrid-view").css("max-height","200px");
			$("#layout_szo_onlinePanel .datagrid-view .datagrid-view2 .datagrid-body").css("max-height","180px").css("overflow-y","auto");
		});
	});
</SCRIPT>
</head>
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<!-- 顶部-->
	<div region="north" border="false" title="SZO_v3.1 Simple版本" style="BACKGROUND:#E6E6FA;height: 85px; padding: 1px; overflow: hidden;">
	...
	<div collapsed="true" region="east" iconCls="icon-reload" title="辅助工具" split="true" style="width: 190px;">
		...
		<div id="layout_szo_onlinePanel" data-options="fit:true,border:false" title="用户在线列表">
			<table id="layout_szo_onlineDatagrid"></table>
		</div>
	...
	<div region="south" border="false" style="height: 25px; overflow: hidden;">
		<div align="center" style="color: #CC99FF; padding-top: 2px">
			&copy; 版权所有 <span class="tip"><a href="http://www.szo.org" title="SZO_v3.1 Simple版本">SZO_v3.1</a> (推荐谷歌浏览器，获得更快响应速度) 技术支持:<a href="#" title="SZO_v3.1 Simple版本">SZO_v3.1</a>
			</span>
		</div>
	</div>
