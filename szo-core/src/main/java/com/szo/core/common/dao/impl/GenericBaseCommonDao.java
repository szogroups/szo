package com.szo.core.common.dao.impl;

import com.szo.core.annotation.SzoEntityTitle;
import com.szo.core.common.dao.IGenericBaseCommonDao;
...
import com.szo.core.common.hibernate.qbc.*;
...
import com.szo.core.util.ToEntityUtil;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable> implements IGenericBaseCommonDao {
    ...
    public List<DBTable> getAllDbTableName() {
        ...
        for (String key : (Set<String>) metaMap.keySet()) {
            ...
            try {
                c = Class.forName(key);
                SzoEntityTitle t = c.getAnnotation(SzoEntityTitle.class);
    ...
    public List<Map<String, Object>> findForJdbc(String sql, int page, int rows) {
        //封装分页SQL
        sql = JdbcDao.szoCreatePageSql(sql, page, rows);
