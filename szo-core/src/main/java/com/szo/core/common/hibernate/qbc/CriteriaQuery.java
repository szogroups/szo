...
import com.szo.core.tag.vo.datatable.DataTables;
import com.szo.core.tag.vo.datatable.SortDirection;
import com.szo.core.tag.vo.datatable.SortInfo;
...
public class CriteriaQuery implements Serializable {
     ...
     * @param query
     * @param source
     * @param dest   hql:(this_.0 like ? or this_.1 like ?) 表示法:cq.add(cq.or(cq, 0,
     *               1));
     * @return
     */
