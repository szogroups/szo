...
import com.szo.core.def.ConstantsDefs;
...
public class SzoSqlUtil {
    ...
    public static String getMethodSqlLogic(String methodUrl) {
        ...
        String projectPath = getAppPath(SzoSqlUtil.class);
...
//		返回读取指定资源的输入流   
        InputStream is = SzoSqlUtil.class.getResourceAsStream(sqlurl);
...
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
    ...
    public static void main(String[] args) {
        //System.out.println(getAppPath(SzoSqlUtil.class));
        System.out.println(getCountSqlBySql("SELECT * 	from SZO_DICT_PARAM WHERE 1=1"));
    }
