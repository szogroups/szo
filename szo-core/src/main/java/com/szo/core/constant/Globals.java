...
public final class Globals {
    ...
    static {
        String button_authority_szo = ResourceUtil.getSessionattachmenttitle("button.authority.szo");
        if ("true".equals(button_authority_szo)) {
