package com.szo.core.extend.hqlsearch;

import com.szo.core.common.hibernate.qbc.CriteriaQuery;
import com.szo.core.extend.hqlsearch.util.StringUtil;
...
public class HqlGenerateUtil {
    ...
    public static void installHql(CriteriaQuery cq, Object searchObj) {
      ...
      /*
  	 * 下面的方法是重载 com.szo.core.extend.hqlsearch.HqlGenerateUtil.installHql(CriteriaQuery, Object)
  	 * 其目的是拓展区间查询功能
  	 * 注：
  	 ...
  	 * 	改为<br/>
  	 * 		com.szo.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, ${entityName?uncap_first}, request.getParameterMap());
  	 * 	因模版里不方便注释，故在此处说明
  	 */
