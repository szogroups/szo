...
import com.szo.core.util.DataUtils;
...
public class RepairServiceImpl extends CommonServiceImpl implements
    ...
    private void repairLog() {
        ...
        try {
            ...
            log6.setLogcontent("SzoDemo例子: 12被删除 成功");
            ...
            log7.setLogcontent("SzoDemo例子: 12被删除 成功");
            ...
            log8.setLogcontent("SzoDemo例子: 12被删除 成功");
            ...
            log16.setLogcontent("SzoDemo例子: 12被添加成功");
    ...
    private void repairDemo() {
        ...
        String html = new FreemarkerHelper().parseTemplate(
                "/szo/system/txt/valid-code-demo.ftl", null);
    ...
    private void repairAttachment() {
        ...
        treaty.setAttachmenttitle("SZO平台协议");
        treaty.setRealpath("SZO平台协议");
        ...
        analyse.setAttachmenttitle("分析SZO与其他的开源项目的不足和优势");
        analyse.setRealpath("分析SZO与其他的开源项目的不足和优势");
        ...
        standard.setAttachmenttitle("SZO团队开发规范");
        standard.setRealpath("SZO团队开发规范");
        ...
        taghelp.setAttachmenttitle("SZOUI标签库帮助文档v3.2");
        taghelp.setRealpath("SZOUI标签库帮助文档v3.2");
    ...
    private void repairMenu() {
        ...
        demo.setFunctionUrl("szoDemoController.do?szoDemo");
        ...
        onetable.setFunctionUrl("szoNoteController.do?szoNote");
        ...
        onetoMany.setFunctionUrl("szoOrderMainController.do?szoOrderMain");
        ...
        TSFunction excel1 = new TSFunction();
        excel1.setFunctionName("新版Excel导出");
        excel1.setFunctionUrl("courseController.do?course");
        excel1.setFunctionLevel((short) 1);
        excel1.setFunctionOrder("5");
        excel1.setTSFunction(commondemo);
        excel1.setTSIcon(pic);
        commonDao.saveOrUpdate(excel1);
        ...
        jdbcdemo.setFunctionUrl("szoJdbcController.do?szoJdbc");
        ...
        sqlsep.setFunctionUrl("szoJdbcController.do?dictParameter");
        ...
        notag1.setFunctionUrl("szoEasyUIController.do?szoEasyUI");
        ...
        notag2.setFunctionUrl("szoOrderMainNoTagController.do?szoOrderMainNoTag");
        ...
        htmledit.setFunctionUrl("szoDemoController.do?ckeditor&isIframe");
        ...
        matterBom.setFunctionUrl("szoMatterBomController.do?goList");
