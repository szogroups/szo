 ...
 */
@Controller
@RequestMapping("/szoEasyUIController")
public class SzoEasyUIController extends BaseController {
    /**
     * Logger for this class
     */
    private static final Logger logger = Logger
            .getLogger(SzoEasyUIController.class);
     ...
     * @return
     */
    @RequestMapping(params = "szoEasyUI")
    public ModelAndView szoEasyUI(HttpServletRequest request) {
        return new ModelAndView("szo/demo/test/szoEasyUIList");
    }
    ...
    public ModelAndView addorupdate(SzoJdbcEntity szoJdbc,
        ...
        return new ModelAndView("szo/demo/test/szoEasyUI");
    }
