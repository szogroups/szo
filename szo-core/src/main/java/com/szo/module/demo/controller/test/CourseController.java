...
public class CourseController extends BaseController {
    ...
    public ModelAndView course(HttpServletRequest request) {
        return new ModelAndView("szo/demo/test/courseList");
    }
    ...
    public void datagrid(CourseEntity course, HttpServletRequest request,
        ...
        com.szo.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq,
                course, request.getParameterMap());
    ...
    public AjaxJson save(CourseEntity course, HttpServletRequest request) {
        ...
        if (StringUtil.isNotEmpty(course.getId())) {
            message = "课程更新成功";
            CourseEntity t = courseService.get(CourseEntity.class,
                    course.getId());
            try {
    ...
    public ModelAndView addorupdate(CourseEntity course, HttpServletRequest req) {
        if (StringUtil.isNotEmpty(course.getId())) {
            course = courseService
                    .getEntity(CourseEntity.class, course.getId());
            req.setAttribute("coursePage", course);
        }
        return new ModelAndView("szo/demo/test/course");
    }
    ...
    public ModelAndView studentsList(CourseEntity course, HttpServletRequest req) {
        ...
        return new ModelAndView("szo/demo/test/CourseStudentList");
    }
