 ...
 */
@Controller
@RequestMapping("/szoOrderMainController")
public class SzoOrderMainController extends BaseController {
    /**
     ...
     * @return
     */
    @RequestMapping(params = "szoOrderMain")
    public ModelAndView szoOrderMain(HttpServletRequest request) {
        return new ModelAndView("szo/demo/test/szoOrderMainList");
    }
    ...
    public ModelAndView addorupdate(SzoOrderMainEntity szoOrderMain,
        ...
        return new ModelAndView("szo/demo/test/szoOrderMain");
    }
     ...
     * @return
     */
    @RequestMapping(params = "szoOrderProductList")
    public ModelAndView szoOrderProductList(SzoOrderMainEntity szoOrderMain,
                                            HttpServletRequest req) {
        ...
        return new ModelAndView("szo/demo/test/szoOrderProductList");
    }
     ...
     * @return
     */
    @RequestMapping(params = "szoOrderCustomList")
    public ModelAndView szoOrderCustomList(SzoOrderMainEntity szoOrderMain,
                                           HttpServletRequest req) {
        if (StringUtil.isNotEmpty(szoOrderMain.getGoOrderCode())) {
        ...
        return new ModelAndView("szo/demo/test/szoOrderCustomList");
    }
}
